...
var app = (function () {
	...
	*/
	...
	var file = "src/FetchExample.svelte"; // (29:1) {:catch error}
	...
	function create_then_block(ctx) {
	  ...
	  var block = {
	    c: function create() {
	      ...
	      code0 = element("code");
	      t = text(t_value);
	      add_location(code0, file, 23, 6, 436);
	      add_location(code1, file, 22, 4, 423);
	      add_location(pre, file, 21, 2, 413);
	    },
	    m: function mount(target, anchor) {
	...
	function create_fragment(ctx) {
	  ...
	  var block = {
	    c: function create() {
	      ...
	      t2 = space();
	      info.block.c();
	      add_location(hr, file, 16, 1, 299);
	      add_location(p, file, 17, 1, 307);
	      add_location(div, file, 15, 0, 292);
	    },
	...
	function instance($$self, $$props, $$invalidate) {
	  ...
	  Object.keys($$props).forEach(function (key) {
	    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<FetchExample> was created with unknown prop '".concat(key, "'"));
	  });
	...
	function create_fragment$1(ctx) {
	  ...
	  var block = {
	    c: function create() {
	      ...
	      add_location(h1, file$1, 6, 1, 95);
	      add_location(h2, file$1, 7, 1, 119);
	      attr_dev(a, "href", "https://svelte.dev/tutorial");
	      add_location(a, file$1, 9, 12, 172);
	      add_location(p, file$1, 8, 1, 156);
	      attr_dev(main, "class", "svelte-1tky8bj");
	      add_location(main, file$1, 5, 0, 87);
	    },
	    l: function claim(nodes) {
	...
	var FORCED$2 = NEGATIVE_ZERO || !STRICT_METHOD$2;
	...
	var global$2 = typeof globalThis !== 'undefined' && globalThis || typeof self !== 'undefined' && self || typeof global$2 !== 'undefined' && global$2;
	var support = {
